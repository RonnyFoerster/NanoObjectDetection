...
ParameterJsonFile = r'C:\Users\foersterronny\Desktop\Test-Tutorial\9nm\parameter.json'
...
#%% animation
nd.Animate.AnimateDiameterAndRawData_Big(rawframes_np, sizes_df_lin_x.copy(), traj_final, ParameterJsonFile)
